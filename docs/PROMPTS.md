...
| 2026-07-09 | Preparar relatorio e defesa | Escrever fonte do relatorio sem numeros nao medidos e organizar a defesa oral | `docs/RELATORIO.md`, `docs/DEFESA.md`, `docs/ENTREGA_FINAL.md` |
